...
public class CompassActivity extends Activity {
    ...
    Sensor magneticSensor, accleSensor;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        accleSensor = sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        ...
        sensorManager.registerListener(listener, accleSensor, SensorManager.SENSOR_DELAY_UI);
